...
class UNET_ResidualBlock(nn.Module):
    ...
    def forward(self, feature, time):
        ...
        # batch_size, inchannel, h, w -> batch_Size, inchannels, h , ww
        ...
        # add width and height dimention to time 
...
class UNET_AttentionBlock(nn.Module):
    ...
    def forward(self, x , context):
        # x: batch_size , feature, Heght, Width 
...
class UNET(nn.Module):
    ...
    def forward(self, x , context, time):
        # x: batch_size, 4, height / 8, width / 8 use output from decoder layer
        ...
        for layers in self.decoders: 
            # cắt bở đi các lớp encoder trước đó sử dụng hàm cat để nối 
            # các lớp layer decoder lại với nhau theo chiều hàng 
